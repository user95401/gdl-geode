...
namespace gdl {
    ...
    GDLAPI_DLL const char* getLanguageName(Language language = getCurrentLanguage());
    GDLAPI_DLL const char* getLanguageCodename(Language language = getCurrentLanguage());

    GDLAPI_DLL const char* getTranslation(const char* id, Language language = getCurrentLanguage());
